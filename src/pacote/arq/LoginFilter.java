...
public class LoginFilter implements Filter {
	 ...
	 * */
	private final String[] urlsPermitidas = {"http://localhost:8080/Projeto3B/publico/inicio.xhtml"};
	...
	public void doFilter(ServletRequest req, ServletResponse res,
        ...
        //Indica se o acesso será permitido ou não. Por padrão, não é permitido. 
   		...
   		deve ser permitido */
   		if (reqUrl.contains("/publico/") || reqUrl.equals("/Projeto3B/") 
        ...
        if (session.getAttribute("usuarioLogado") != null || permitido) {
        	...
        	response.sendRedirect("/Projeto3B/sessao_expirada.html");
            return;
        }
